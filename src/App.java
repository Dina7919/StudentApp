...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Emploee e2 = new Emploee("Сидоров", 35, "программист");
       ...
       // EmploeeController.paySalary(s1);
        ...
        AverageAge.averageAge2(teachers); // вывод среднего учителей_
        AverageAge.averageAge2(emploees); // вывод среднего сотрудников_
        AverageAge.averageAge2(students); // вывод среднего студентов_
